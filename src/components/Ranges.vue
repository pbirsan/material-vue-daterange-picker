<template>
    <div class="ranges">
        <ul>
            <li v-for="(item, index) in presets_"
                :key="index"
        ...
        computed: {
            chosenLabel() {
                ...
                for (const preset of this.presets) {
                    ...
                    if (typeof picker.start_.format == "function" && picker.start_.format(ftm) === start.format(ftm) && picker.end_.format(ftm) === end.format(ftm)) {
                        customRange = false;
